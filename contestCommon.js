  ...
  contest.finishedDay = function () {
    ...
    for (var i = 0; i < agents.length; i++) {
      ...
      for (var j = i + 1; j < agents.length; j++) {
        ...
        var foodEarned = 0;
        if (a1r == 'h') { foodEarned += 6; a1.foodOutcome -= 3; a1.hunts++; a1.huntsToday++; totalRoundHunts++; }
        //if (a1r == 'h') { foodEarned += 6; a1.foodOutcome -= 3; a1.hunts++; a1.huntsToday++; totalRoundHunts++; }
        //else { a1.foodOutcome -= 2; }
        else { a1.foodOutcome -= 3; }
        if (a2r == 'h') { foodEarned += 6; a2.foodOutcome -= 3; a2.hunts++; a2.huntsToday++; totalRoundHunts++; }
        //if (a2r == 'h') { foodEarned += 6; a2.foodOutcome -= 3; a2.hunts++; a2.huntsToday++; totalRoundHunts++; }
    ...
    if (0){//(totalRoundHunts > capital.blessingThreshold * totalRounds) {
